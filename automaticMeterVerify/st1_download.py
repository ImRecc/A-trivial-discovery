...
# ================= 配置区 =================
BASE_URL = "http://www.yndlsw.com:8001"
...
def main():
    ...
    for item in records:
        ...
        ''' if not os.path.exists(save_path):
            try:
                headers = {
                    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36 Edge/123.0.0.0',
                    'Cookie': MY_COOKIE,  # 加上这行，服务器就认出你是“自己人”了
                    'Referer': 'http://www.yndlsw.com:8001/MRS_MeterReadingData/Index' # 有些服务器会检查你是从哪个页面跳过来的
                }
